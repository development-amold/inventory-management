class GuitarsController < ApplicationController
  ...
  # GET /guitars.json
  def index
    @guitars = Guitar.search(params[:q]).paginate(:page => params[:page],:per_page => 10)
  end
  ...
  private
    ...
    def guitar_params
      params.require(:guitar).permit(:brand_id, :category_id, :name, :unit_price, :stringscount, :purchased_at, :q)
    end
end
