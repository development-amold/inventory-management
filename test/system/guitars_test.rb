...
class GuitarsTest < ApplicationSystemTestCase
  ...
  test "creating a Guitar" do
    ...
    fill_in "Category", with: @guitar.category_id
    fill_in "Name", with: @guitar.name
    fill_in "Purchased At", with: @guitar.purchased_at
    fill_in "Stringscount", with: @guitar.stringscount
    fill_in "Unit Price", with: @guitar.unit_price
